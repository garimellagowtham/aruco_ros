...
# Notes: 
# The install_aruco.sh script installs the aruco library in the aruco folder. It also provides various utilities to create boards of different types, calibrate camera etc. These utilites are needed by the current project if you want to use different kinds of boards
# TODO
# Also add hrm_board_detector in terms of ros which reads the images live and figures out the pose
# The image stream should be either grayscale  or rgb (NOT SURE ABOUT THIS)
