...
# TODO: Add a script for converting the config files generated by the aruco utilities into corresponding ros formats or have some kind of connection with ros
# The single.cpp should be a simple marker detection code
# Change double.cpp to a board_detector.cpp
# Also add hrm_board_detector in terms of ros which reads the images live and figures out the pose
# In most of the cases, we can use the existing code from utils with enough emphasis that I have not written the base code.
